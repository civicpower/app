...
<div id="init_hidden" class="d-none">
    ...
    <div class="small-box px-0">
        ...
        <div id="ballot-wait-end" class="mx-5 alert alert-danger text-center font-weight-bold d-none">Veuillez attendre la fin de la consultation pour voir les résultats</div>
...
<div id="hidden-stock" class="d-none">
    <div class="question_item mt-4">
        ...
        <div class="question_qcm d-none alert alert-info mw70 text-center mx-auto">
            Vote à préférences multiples
            <span class="option-strict d-none">strict</span>
            <span class="option-max d-none">max</span> :
            <i><span class="option-until dnone">Jusqu'à</span> <span class="nb-choice">0</span> options choisies par le votant</i>
        </div>
    ...
    <div class="option_item row">
        <div class="px-3 col-10 cpcolor-blue1 cp_text_14_bold  px-4 option_title div_title_span"></div>
